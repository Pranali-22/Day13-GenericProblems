...
public class MaximumGenerics {
	...
	//Find maximum among n number of inputs
		...
		public static void main(String[] args) {
			...
			System.out.println("Maximum of Integer = "+maximumof3(integerNum1, integerNum2, integerNum3, integerNum4));
			...
			System.out.println("Maximum of String = "+maximumof3(stringValue1, stringValue2));
